#--------------------------------------------------------------------#
#
# HTML Document Checker - Printing to shell window
#
...
print('Checking HTML syntax for file "' + html_file + '"\n')
...
if html_code.find('<!DOCTYPE html>') == 0:
    print('File correctly identifies itself as HTML')
else:
    print('File does not tell the browser what type it is!')
...
if  start_head_pos != -1 and end_head_pos != -1 and \
    ...
    print('File has a "head" section')
else:
    print('File does not have a valid "head" section!')
...
if  start_title_pos != -1 and end_title_pos != -1 and \
    ...
    print('File contains a title for the document')
else:
    print('File does not contain a valid title for the document!')
...
if  start_body_pos != -1 and end_body_pos != -1 and \
    ...
    print('File contains a body for the document')
else:
    print('File does not contain a valid body for the document!')
