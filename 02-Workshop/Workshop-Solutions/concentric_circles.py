...
#
# 1) Lift up the pen
# 2) Go to the centre of the screen
# 3) Go to a position on the intended circle's perimeter
...
# Choose a line thickness and colour
pensize(5) # pixels
color('blue')

# Draw the first circle (using the strategy above)
penup()
home()
forward(radii[0])
left(90)
