...
random_number = []
for random in range (number_of_trials):
    random_number.append(randint (1, limit_of_random_numbers ))

print (random_number)
print ("the max random number is ", max (random_number))
print ("the min random number is ", min (random_number))
