...
# main window
interest_rate = Entry(loan_window, width = 10, justify = RIGHT, font = gui_font)
num_years = Entry(loan_window, width = 10, justify = RIGHT, font = gui_font)
loan_amount = Entry(loan_window, width = 10, justify = RIGHT, font = gui_font)
