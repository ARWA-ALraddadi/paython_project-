#--------------------------------------------------------------------#
#
# Mars lander example - Checking validity of parameters
#
...
# value of the argument provided to the altimeter function
# is in the expected range and uses a "best guess"
# default if it isn't.
#
