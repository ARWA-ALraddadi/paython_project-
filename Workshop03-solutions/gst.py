...
#---------------------------------------------------------
# A function to return the GST component to be added
# to a given wholesale price (where GST = 10%)
#
def gst(price):
     gst_rate = 0.1 # Fixed value
     return price * gst_rate # Alternative: price / 10
