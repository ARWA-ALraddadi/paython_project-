...
#
""" 
>>> cube(2) # Test 1 - integer
8

>>> cube(10) # Test 2 - integer
1000

>>> cube(0.5) # Test 3 - floating point
0.125
...
#---------------------------------------------------------
# A function to return the cube of a given number
#
def cube(number):
    # Return the number multiplied by itself three times
