...
#---------------------------------------------------------
# Given a string, return it with all alphabetic
...
#---------------------------------------------------------
# Given a string, return it with all spaces removed.
#
...
#---------------------------------------------------------
# Given a string, return it with all occurrences of '.'
# replaced with the word 'STOP'.
#
def replace_stops(text):
