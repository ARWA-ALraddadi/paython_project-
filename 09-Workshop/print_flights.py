...
def print_flights(departure_city):
    ...
    sql = "SELECT * FROM flights WHERE FromCityCode = '" + departure_city+ "'"
    ...
    for flight_num, from_city, to_city, seats, aircraft in rows:
        print(flight_num, from_city, to_city, seats, aircraft)
