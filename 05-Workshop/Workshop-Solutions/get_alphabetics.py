...
# Return a given string with all non-alphabetic characters
# removed, in lower case
#
def get_alphas(text):

    # Accumulator for alphabetic characters
    alphas = ''

    # Get all alphabetic characters from the given text
    for char in text:
        if char.isalpha():
            alphas = alphas + char
