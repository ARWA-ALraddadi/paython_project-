...
num_one_digit_pages = (9- 1)+1
num_two_digit_pages = (99 -10)+1
num_three_digit_pages = (366 - 100)+1

# Now work out how many individual digits there are

total_digits = (num_one_digit_pages * 1) + \
               (num_two_digit_pages * 2) + \
               (num_three_digit_pages * 3)
