...
pass # This statement does nothing - it is used to mark missing code
...
PRETTY = [letters[9],letters[3],letters[2],letters[4],letters[4],letters[5]]
print (PRETTY)

print(letters[9],letters[3],letters[2],letters[4],letters[4],letters[5]) #['P', 'R', 'E', 'T', 'T', 'Y']
print(letters[9]+letters[3]+letters[2]+letters[4]+letters[4]+letters[5]) #PRETTY
pass
