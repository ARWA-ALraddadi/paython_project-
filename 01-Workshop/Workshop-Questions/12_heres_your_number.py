...
day = 13 # Put your day here (one or two digits)
month = 4 # Put your month here (one or two digits)
year = 1995 # Put your year here (one to four digits)
