...
#
# This version merges the results of the work done by the
# two development teams.  It replaces the stubs used in the
# prototype GUI with the actual functions (and their unit
# tests).  The user interface is still very basic.
#
