...
##### DEFINE YOUR total_characters FUNCTION HERE

# An iterative function to count the number of characters 
# in a given list of words. 
def total_characters(word_list):

    # Initialise a new integer variable, running_total
    running_total = 0
 
    # For every word in the list, get its length and
