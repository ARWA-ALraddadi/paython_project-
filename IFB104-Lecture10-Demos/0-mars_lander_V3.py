#--------------------------------------------------------------------#
#
# Mars lander example - Allowing for unexpected values
#
...
#
# In this version the main loop and the conditional statement
# at the end are modified to allow for the possibility that
# the lander descends below "ground level", e.g., by landing
# in a deep crater.
#
