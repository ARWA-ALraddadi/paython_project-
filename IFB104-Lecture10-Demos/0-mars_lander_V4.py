#--------------------------------------------------------------------#
#
# Mars lander example - Error checking with an assertion
#
...
#
# In this version the "sanity check" on the argument to the
# altimeter is replaced with an assertion that documents
# the expected range of values and raises an exception if
